                            ...
                            <div class="col-xlg-2 col-lg-4 col-md-4">
                                <div class="card-body inbox-panel"><a href="app-compose.html" class="btn btn-danger m-b-20 p-10 btn-block waves-effect waves-light">Compose</a>
                                    <ul class="list-group list-group-full">
                                        ...
                                        <li class="list-group-item ">
                                            <a href="javascript:void(0)"> <i class="mdi mdi-file-document-box"></i>
                                                Sent Announcement </a>
                                        </li>
                                        <li class="list-group-item">
                                            ...
                                            <table class="table table-hover no-wrap">
                                                ...
                                                <tr class="unread">
                                                    ...
                                                    <td class="max-texts"> <a href="/announcement-details" /><span
                                                                class="label
                                                    label-info m-r-10">Work</span> Lorem ipsum perspiciatis unde omnis iste natus error sit voluptatem</td>
