                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form id="form-course" class="form-horizontal m-t-40" method="post"
                                  action="/course-create_assign_template"
                                  enctype="multipart/form-data" data-toggle="validator" role="form">
                                {{csrf_field()}}
                                {{--<input type="hidden" id="course_id" name="course_id" value="0"/>--}}
                                <div class="col-md-6 m-b-20">
                                    <label>{{ __('strings.Number') }}</label>
                                    <input name="number" type="number" class="form-control form-control-line" placeholder="Type here">
                                </div>
                                <div class="col-md-6 m-b-20">
                                    <label>{{ __('strings.Name') }}</label>
                                    <input name="case" type="text" class="form-control form-control-line" placeholder="Type here">
                                </div>
                                <div class="col-md-6 m-b-20">
                                    <label class="control-label">{{ __('strings.Instructions') }}</label>
                                    <textarea name="instructions" class="form-control form-control-line" rows="5" placeholder="Type here"> </textarea>
                                </div>
                            </form>
                                <div class="form-group" align-items-center>
                                    <button id="submit-assignTemplate" type="submit" class="btn btn-success btn-rounded"> {{ __('strings.Submit') }}
                                    </button>
