                ...
                <div class="col-lg-12">
                    <div class="card card-outline-info">
                        <div class="card-header">
                            <h4 class="m-b-0 text-white">{{ __('strings.UpdateAssignment') }}</h4>
                        </div>
                        <div class="card-body">
                            <form action="/edit-assign-template"
                                  method="post"
                                  enctype="multipart/form-data">
                                {{csrf_field()}}
                                <input type="hidden" id="assigntemplate_id" name="assigntemplate_id" value="{{$assigntemplate->id}}"/>
                                <div class="form-body">
                                    ...
                                    <div class="row p-t-20">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="control-label">{{ __('strings.Number') }}</label>
                                                <input type="text" name="number" id="firstName" class="form-control" value="{{$assigntemplate->number}}">
                                                <small class="form-control-feedback"> Edit the assignment number </small> </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row p-t-20">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="case" id="firstName" class="form-control" value="{{$assigntemplate->case}}">
                                                <small class="form-control-feedback"> Edit the asssignment name </small> </div>
                                        </div>
                                    </div>
                                    <!--/row-->
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="control-label">{{ __('strings.Instructions') }}</label>
                                                <textarea name="instructions" class="form-control" id="exampleTextarea" rows="7" >{{$assigntemplate->instructions}}</textarea>
                                                {{--<input type="textarea" id="firstName" class="form-control" value="{{$coursetemplate->course_content}}">--}}
                                                <small class="form-control-feedback"> Edit instructions </small> </div>
                                        </div>
                                    </div>
