        ...
        <div class="navbar-collapse">
                                ...
                                {{--<div id="carouselExampleControls" class="carousel slide" data-ride="carousel">--}}
                                    {{--<div class="carousel-inner" role="listbox">--}}
                                        ...
                                        {{--<div class="carousel-item">--}}
                                            {{--<div class="container"><img class="d-block img-fluid" src="{{ asset--}}
                                            {{--('images/big/img2.jpg') }}" alt="Second slide"></div>--}}
                                        {{--</div>--}}
                                        {{--<div class="carousel-item">--}}
                                            {{--<div class="container"><img class="d-block img-fluid" src="{{ asset--}}
                                            {{--('images/big/img3.jpg') }}" alt="Third slide"></div>--}}
                                        {{--</div>--}}
                                    {{--</div>--}}
            ...
            <ul class="navbar-nav my-lg-0">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right scale-up">
                        <a class="dropdown-item" href="#"><i class="flag-icon flag-icon-in"></i> Swedish</a>
