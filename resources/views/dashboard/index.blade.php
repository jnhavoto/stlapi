                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="ct-chart10" style="height: 360px;"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row text-center">
                                    <div class="col-lg-4 col-md-4 m-t-20">
                                        <h1 class="m-b-0 font-light">250</h1>
                                        <small>Total Finished</small>
                                    </div>
                                    <div class="col-lg-4 col-md-4 m-t-20">
                                        <h1 class="m-b-0 font-light">100</h1>
                                        <small>Total Ongoing</small>
                                    </div>
                                    <div class="col-lg-4 col-md-4 m-t-20">
                                        <h1 class="m-b-0 font-light">30</h1>
