                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i
                            ...
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="app-email.html">Courses</a></li>
                                <li><a href="app-chat.html">Assignments </a></li>
                                {{--<li><a href="app-email-detail.html">Mailbox Detail</a></li>--}}
                                <li><a href="app-compose.html">Add Course</a></li>
                                <li><a href="app-compose.html">Add Assignment</a></li>
                            </ul>
                        </li>
                        <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i
                            ...
                            <ul aria-expanded="false" class="collapse">
                                ...
                                <li><a href="app-chat.html">Chats</a></li>
                                {{--<li><a href="app-compose.html">Compose Message</a></li>--}}
                                {{--<li><a href="app-contact2.html">Contacts Grid</a></li>--}}
                                {{--<li><a href="app-contact-detail.html">Contacts Detail</a></li>--}}
                            </ul>
                        </li>
                        {{--<li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i--}}
                                        {{--class="mdi mdi-email"></i><span class="hide-menu">Communications</span></a>--}}
                            {{--<ul aria-expanded="false" class="collapse">--}}
                                {{--<li><a href="app-email.html">Notifications</a></li>--}}
                                {{--<li><a href="app-chat.html">Chats</a></li>--}}
                                {{--<li><a href="app-email-detail.html">Mailbox Detail</a></li>--}}
