...
class AddForeignKeysToGroupsAssignmentDescriptionsTable extends Migration {
	...
	public function up()
	{
		...
		{
			$table->foreign('assignment_descriptions_id', 'fk_groups_has_assignment_descriptions_assignment_descriptions1')->references('id')->on('assignment_description')->onUpdate('NO ACTION')->onDelete('NO ACTION');
