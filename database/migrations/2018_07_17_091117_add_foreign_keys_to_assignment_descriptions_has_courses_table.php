...
class AddForeignKeysToAssignmentDescriptionsHasCoursesTable extends Migration {
	...
	public function up()
	{
		...
		{
			$table->foreign('assignment_descriptions_id', 'fk_assignment_descriptions_has_courses_assignment_descriptions1')->references('id')->on('assignment_descriptions')->onUpdate('NO ACTION')->onDelete('NO ACTION');
